...
<style>
    ...
    .footer-content-container {
        ...
        gap: 0px 0px; 
		grid-template-areas: 
		  "facebook instagram linkedin toggle discord contact email"; 
    ...
    footer.collapsed .footer-icon-wrapper {
        display: none;
    } 
    ...
    .footer-icon-wrapper.discord {
        grid-area: discord;
        position: sticky;
    }

    .footer-icon-wrapper.contact {
        grid-area: contact;
        position: sticky;
    }

    .footer-icon-wrapper.email {
        grid-area: email;
        position: sticky;
    }
