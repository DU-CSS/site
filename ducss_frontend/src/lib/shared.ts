...
export const sponsors = [
    new Map<string, any>([
        ...
        ['Photo', 'src/lib/images/sponsors/arista.png']
    ]),
    new Map<string, any>([
        ['Title', 'Millennium'],
        ...
        ['Photo', 'src/lib/images/sponsors/millenium.png']
    ]),
    new Map<string, any>([
        ['Title', 'Stripe'],
        ...
        ['Photo', 'src/lib/images/sponsors/stripe.png']
    ]),
    new Map<string, any>([
        ['Title', 'PwC'],
        ...
        ['Photo', 'src/lib/images/sponsors/pwc.png']
    ]),
    new Map<string, any>([
        ['Title', 'Bloomberg'],
        ...
        ['Photo', 'src/lib/images/sponsors/bloomberg.png']
    ]),
    new Map<string, any>([
        ['Title', 'MongoDB'],
        ...
        ['Photo', 'src/lib/images/sponsors/mongodb.png']
    ]),
    new Map<string, any>([
        ...
        ['Photo', 'src/lib/images/sponsors/sig.png']
    ])
]
